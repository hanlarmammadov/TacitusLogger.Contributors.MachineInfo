...
namespace TacitusLogger.Contributors.MachineInfo.IntegrationTests
{
    [TestFixture]
    public class MachineInfoContributorTests
    {
        [Test]
        public void Logger_Containing_Machine_Info_Log_Contributors_And_One_Log_Group_With_Several_Custom_Destinations()
        {
            // Arrange 
        ...
        [Test]
        public async Task Async_Logger_Containing_Machine_Info_Log_Contributors_And_One_Log_Group_With_Several_Custom_Destinations()
        {
            // Arrange 
            // Build logger with two log groups
            var logDestination1Mock = new Mock<ILogDestination>();
